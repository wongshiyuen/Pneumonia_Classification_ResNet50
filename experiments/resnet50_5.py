...
#=====================================================================================================
#MIX-UP USING DECREASING ALPHA VALUES WITH INCREASING EPOCH
def mixupImage(imgBatch, label, decay, epoch, maxEpoch, alphaMax=0.2):
    progress = min(1, decay*epoch/maxEpoch) #Upper limit of progress at 1 (100%)
    alpha = alphaMax*(1-progress) #Linear decay
    if alpha > 0:
...
pthName = "best_resnet50_5(decay2).pth"
#=====================================================================================================
...
for epoch in range(epochs):
    ...
    for images, labels in trainLoader:
        ...
        mixedImg, originalLabel, shuffledLabel, lam = mixupImage(images, labels, decay, epoch, epochs, alphaMax)
