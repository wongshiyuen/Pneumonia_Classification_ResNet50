...
pthName = "best_resnet50_3(labelsmoothing=0.05).pth"
#=====================================================================================================
...
criterion = nn.CrossEntropyLoss(
    weight=weights, #When computing loss, multiply loss of class by its weight
    label_smoothing=0.05 #Label smoothing; 0.05=safe default, 0.1 for noisy data, can underfit if >0.1
)
